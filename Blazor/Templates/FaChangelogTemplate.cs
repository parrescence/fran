...
/// <summary>
/// A changelog / release notes page template: <see cref="FaStandardShell"/> wrapped around
/// a changelog header with title, description, and action buttons (e.g. RSS subscribe),
/// an optional tag/category filter bar, and a chronological timeline stream of product releases.
/// </summary>
public sealed class FaChangelogTemplate : ComponentBase
{
    ...
    /// <summary>Changelog page title, e.g. "Changelog".</summary>
    [Parameter] public string Title { get; set; } = "Changelog";

    /// <summary>Subheading description below the title.</summary>
    [Parameter] public string? Description { get; set; } = "New features, bug fixes, and improvements to the platform.";

    /// <summary>Actions at the top-right of the header (e.g. RSS feed button or email subscribe).</summary>
    [Parameter] public RenderFragment? HeaderActions { get; set; }

    /// <summary>Optional category or version filter chips (e.g. All, Features, Fixes, Performance).</summary>
    [Parameter] public RenderFragment? FilterContent { get; set; }

    /// <summary>Chronological timeline entries of releases and updates.</summary>
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddComponentParameter(17, nameof(FaStandardShell.ChildContent), (RenderFragment)(body =>
        {
            ...
            body.AddAttribute(19, "class", "fa-changelog-template");

            // Header row
            body.OpenElement(20, "header");
            body.AddAttribute(21, "class", "fa-changelog-header");

            body.OpenElement(22, "div");
            body.AddAttribute(23, "class", "fa-changelog-header-main");
            body.OpenElement(24, "h1");
            body.AddAttribute(25, "class", "fa-changelog-title");
            ...
            if (!string.IsNullOrWhiteSpace(Description))
            {
                ...
                body.AddAttribute(28, "class", "fa-changelog-description");
                body.AddContent(29, Description);
                body.CloseElement(); // p
            }
            body.CloseElement(); // fa-changelog-header-main

            if (HeaderActions != null)
            {
                body.OpenElement(30, "div");
                body.AddAttribute(31, "class", "fa-changelog-actions");
                body.AddContent(32, HeaderActions);
                body.CloseElement(); // fa-changelog-actions
            }
            ...
            if (FilterContent != null)
            {
                ...
                body.AddAttribute(34, "class", "fa-changelog-filters");
                body.AddContent(35, FilterContent);
                body.CloseElement(); // fa-changelog-filters
            }

            // Timeline stream
            body.OpenElement(36, "div");
            body.AddAttribute(37, "class", "fa-changelog-timeline");
            body.AddContent(38, ChildContent);
            body.CloseElement(); // fa-changelog-timeline

            body.CloseElement(); // fa-changelog-template
        }));
